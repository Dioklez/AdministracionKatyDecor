...
class $AccountsTable extends Accounts
  ...
  @override
  late final GeneratedColumn<double> pagado = GeneratedColumn<double>(
    'pagado',
    aliasedName,
    false,
    type: DriftSqlType.double,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('contraparte')) {
      ...
      context.missing(_contraparteMeta);
    }
    if (data.containsKey('descripcion')) {
      context.handle(
        _descripcionMeta,
...
class AccountRow extends DataClass implements Insertable<AccountRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['pagado'] = Variable<double>(pagado);
  ...
  factory AccountRow.fromJson(
    ...
    return AccountRow(
      ...
      pagado: serializer.fromJson<double>(json['pagado']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'pagado': serializer.toJson<double>(pagado),
...
class AccountsCompanion extends UpdateCompanion<AccountRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (pagado.present) {
      map['pagado'] = Variable<double>(pagado.value);
    }
    if (saldo.present) {
...
class $AccountPaymentsTable extends AccountPayments
    with TableInfo<$AccountPaymentsTable, AccountPaymentRow> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $AccountPaymentsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'account_payments';
  @override
  VerificationContext validateIntegrity(
    Insertable<AccountPaymentRow> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  AccountPaymentRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return AccountPaymentRow(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  $AccountPaymentsTable createAlias(String alias) {
    return $AccountPaymentsTable(attachedDatabase, alias);
  }
}

class AccountPaymentRow extends DataClass
    implements Insertable<AccountPaymentRow> {
  final int id;
  final int accountId;
  final double monto;
  final String? fecha;
  ...
  AccountPaymentsCompanion toCompanion(bool nullToAbsent) {
    return AccountPaymentsCompanion(
      id: Value(id),
  ...
  factory AccountPaymentRow.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  AccountPaymentRow copyWithCompanion(AccountPaymentsCompanion data) {
    return AccountPaymentRow(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('AccountPaymentRow(')
          ..write('id: $id, ')
  ...
  @override
  int get hashCode =>
      Object.hash(id, accountId, monto, fecha, notas, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is AccountPaymentRow &&
          other.id == this.id &&
...
class AccountPaymentsCompanion extends UpdateCompanion<AccountPaymentRow> {
  final Value<int> id;
  ...
  final Value<String?> notas;
  final Value<String?> createdAt;
  const AccountPaymentsCompanion({
    this.id = const Value.absent(),
  ...
  AccountPaymentsCompanion.insert({
    this.id = const Value.absent(),
    ...
    this.createdAt = const Value.absent(),
       ...
       monto = Value(monto);
  static Insertable<AccountPaymentRow> custom({
    Expression<int>? id,
  ...
  AccountPaymentsCompanion copyWith({
    Value<int>? id,
    Value<int>? accountId,
    Value<double>? monto,
    Value<String?>? fecha,
  ...
  @override
  String toString() {
    return (StringBuffer('AccountPaymentsCompanion(')
          ..write('id: $id, ')
          ..write('accountId: $accountId, ')
          ..write('monto: $monto, ')
          ..write('fecha: $fecha, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $AccountPaymentsTable accountPayments = $AccountPaymentsTable(
    this,
  );
...
class $$AccountsTableFilterComposer
  ...
  ColumnFilters<double> get pagado => $composableBuilder(
    column: $table.pagado,
    builder: (column) => ColumnFilters(column),
  );
...
class $$AccountsTableOrderingComposer
  ...
  ColumnOrderings<double> get pagado => $composableBuilder(
    column: $table.pagado,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$AccountsTableAnnotationComposer
  ...
  GeneratedColumn<double> get pagado =>
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<double> pagado = const Value.absent(),
...
typedef $$AccountsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$AccountPaymentsTableCreateCompanionBuilder =
    AccountPaymentsCompanion Function({
      Value<int> id,
      required int accountId,
      required double monto,
      Value<String?> fecha,
...
typedef $$AccountPaymentsTableUpdateCompanionBuilder =
    AccountPaymentsCompanion Function({
      Value<int> id,
      Value<int> accountId,
      Value<double> monto,
...
class $$AccountPaymentsTableFilterComposer
    extends Composer<_$AppDatabase, $AccountPaymentsTable> {
  $$AccountPaymentsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$AccountPaymentsTableOrderingComposer
    extends Composer<_$AppDatabase, $AccountPaymentsTable> {
  $$AccountPaymentsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$AccountPaymentsTableAnnotationComposer
    extends Composer<_$AppDatabase, $AccountPaymentsTable> {
  $$AccountPaymentsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$AccountPaymentsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          ...
          $$AccountPaymentsTableOrderingComposer,
          $$AccountPaymentsTableAnnotationComposer,
          $$AccountPaymentsTableCreateCompanionBuilder,
          $$AccountPaymentsTableUpdateCompanionBuilder,
          (
            AccountPaymentRow,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$AccountPaymentsTableTableManager(
    _$AppDatabase db,
    $AccountPaymentsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$AccountPaymentsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$AccountPaymentsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$AccountPaymentsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
...
typedef $$AccountPaymentsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $AccountPaymentsTable,
      AccountPaymentRow,
      ...
      (
        AccountPaymentRow,
        BaseReferences<_$AppDatabase, $AccountPaymentsTable, AccountPaymentRow>,
      ),
      AccountPaymentRow,
      PrefetchHooks Function()
    >;
...
class $AppDatabaseManager {
  ...
  $$AccountPaymentsTableTableManager get accountPayments =>
      $$AccountPaymentsTableTableManager(_db, _db.accountPayments);
